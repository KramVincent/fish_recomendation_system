<template>
  <Transition name="notification">
    <div
      ...
      class="flex items-start p-4 rounded-lg shadow-lg pointer-events-auto"
      role="alert"
    >
...
const typeStyles = {
  ...
  error: 'bg-avoid text-white',
  warning: 'bg-moderate text-white',
  info: 'bg-blue-500 text-white',
}

const notificationClasses = computed(() => typeStyles[props.notification.type])
